...
export async function getCountryList(continent: string) {
  ...
  switch (continent) {
    case "africa":
      data = await import('../../../data/africa-countries-list.json')
      return data.default.countries as CountryData[] 
    case "asia":
      data = await import('../../../data/asia-countries-list.json')
      return data.default.countries as CountryData[] 
    case "europe":
      data = await import('../../../data/europe-countries-list.json')
      return data.default.countries as CountryData[] 
    case "northamerica":
      data = await import('../../../data/northamerica-countries-list.json')
      return data.default.countries as CountryData[] 
    case "oceania":
      data = await import('../../../data/oceania-countries-list.json')
      return data.default.countries as CountryData[]
    case "southamerica":
      data = await import('../../../data/southamerica-countries-list.json')
      return data.default.countries as CountryData[] 
    default:
      data = await import('../../../data/countries-list.json')
